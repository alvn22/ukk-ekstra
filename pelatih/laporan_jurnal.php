...
<head>
    ...
    <title>Pelatih - Laporan Jurnal</title>
                    ...
                    <?php
                        ...
                        if(isset($_POST["submit"])){
                            ...
                            if($tgl_mulai > $tgl_selesai){
                                ...
                                $sql = "SELECT * FROM jurnal j JOIN pelatih_ekstra pe ON j.id_user = pe.id_user
                                JOIN ekstra e ON pe.id_ekstra = e.id_ekstra WHERE pe.id_user = $id AND j.tanggal BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <td><?php echo $val['ekstrakulikuler'] ?></td>
                                <td><?php echo date("d F Y",strtotime($val["tanggal"])) ?></td>
