                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                $q = "SELECT COUNT(*) as total FROM jurnal j 
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                $q = "SELECT COUNT(*) as total FROM absensi a 
                                                JOIN pelatih_ekstra pe ON a.id_user = pe.id_user
                                                JOIN ekstra e ON pe.id_ekstra = e.id_ekstra
                                                WHERE pe.id_user = $id";
                                                $r = mysqli_query($con,$q);
                                                $dt = mysqli_fetch_assoc($r);
