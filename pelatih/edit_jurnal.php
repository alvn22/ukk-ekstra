...
<head>
    ...
    <?php 
        ...
        $sql = "SELECT * FROM jurnal WHERE id_jurnal = '$id_jurnal'";
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql = "UPDATE jurnal SET judul='$judul', deskripsi='$deskripsi' WHERE id_jurnal='$id_jurnal'";
            $res = mysqli_query($con,$sql);
            alert('success','Berhasil mengedit jurnal');
            // redirect('jurnal.php');
        }
    ...
    <title>Pelatih - Edit Jurnal</title>
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="nav-item dropdown no-arrow">
                        <a href="jurnal.php" class="nav-link text-dark">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Jurnal</h1>
                    </div>

                    <form class="offset-md-1" method="POST" enctype="multipart/form-data">
                        <div class="col-md-10 mb-3">
                            <label>Ekstrakurikuler:</label>
                            <input type="text" name="ekstra" readonly value="<?php echo $dt['ekstrakulikuler'] ?>" class="form-control">
                        </div>
                        <div class="col-md-10 mb-3">
                            <label>Judul:</label>
                        ...
                        <div class="col-md-10">
                            <a href="jurnal.php" class="btn btn-dark">Kembali</a>
