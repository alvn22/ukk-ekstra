...
<head>
    ...
    <title>Pelatih - Laporan Absensi</title>
                        ...
                        if(isset($_POST["submit"])){
                            ...
                            if($tgl_mulai > $tgl_selesai){
                                ...
                                $q = "SELECT * FROM absensi_siswa a JOIN user u ON a.id_user = u.id_user JOIN jurusan k ON a.id_kelas = k.id_jurusan
                                    JOIN ekstra e ON a.id_ekstra = e.id_ekstra JOIN pelatih_ekstra pe ON a.id_ekstra = pe.id_ekstra WHERE pe.id_user = '$id' AND a.waktu_absen BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
