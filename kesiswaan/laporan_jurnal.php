...
<head>
    ...
    <title>Kesiswaan - Laporan Jurnal</title>
                    ...
                    <?php
                        ...
                        if(isset($_POST["submit"])){
                            ...
                            if($tgl_mulai > $tgl_selesai){
                                ...
                                $sql = "SELECT * FROM jurnal WHERE ekstrakulikuler = '$ekstra' AND tanggal BETWEEN '$tgl_mulai' AND '$tgl_selesai'";
                                            ...
                                            <?php
                                                ...
                                                if($re){
                                                    while($dt = mysqli_fetch_assoc($re)){
                                                        echo "<option value='$dt[nama_ekstra]'>$dt[nama_ekstra]</option>";
                                                    }
                                                }
                                            ?>
                                        </select>
