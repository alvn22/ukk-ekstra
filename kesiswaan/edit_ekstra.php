...
<head>
    ...
    <?php 
        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            $sql = "UPDATE ekstra SET nama_ekstra='$ekstra', waktu='$waktu', hari='$hari' WHERE id_ekstra='$id_ekstra'";
            $res = mysqli_query($con,$sql);
            alert('success','Berhasil mengedit ekstrakurikuler');
            // redirect('ekstra.php');
        }
    ...
    <title>Kesiswaan - Edit Ekstrakurikuler</title>
